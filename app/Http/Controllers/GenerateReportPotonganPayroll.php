...
class GenerateReportPotonganPayroll extends Controller
{
    public function index()
    {
        $indents = [];
        return view('report.generate.potongan-payrol.new', compact('indents'));
    }
...
//        dd($dataDepositMember);
    ...
    public function download(Request $request)
    {
        ...
        $filename = 'payrol.xlsx';
        $path = \Storage::disk('payroll')->path($filename);
        if(\Storage::disk('payroll')->exists('payrol.xlsx')){
