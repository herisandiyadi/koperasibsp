...
class GenerateReportMonthlyController extends Controller
{
    public function index()
    {
        $indents = [];
        return view('report.generate.monthly.new', compact('indents'));
    }
...
//        dd($dataDepositMember);
    ...
    public function download(Request $request)
    {
        ...
        $filename = 'monthly_simpanan_pinjaman.xlsx';
        $path = \Storage::disk('template')->path($filename);
        if(\Storage::disk('template')->exists('monthly_simpanan_pinjaman.xlsx')){
